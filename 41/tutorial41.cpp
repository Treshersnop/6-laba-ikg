...
public:
    ...
    имеется проход рендера для всех объектов сцены и проход постобработки для размытия*/
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, false, "Karimova Tutorial 41")) {
        return 1;
    }
